...
<img src="https://raw.githubusercontent.com/arkikky/vermilion/refs/heads/master/images/vermilion-HTMLxCSS.png" alt="Banner Showcase 1" width="100%" height="auto" />
<img src="https://raw.githubusercontent.com/arkikky/vermilion/refs/heads/master/images/vermilion-NextxTypeScript.png" alt="Banner Showcase 2" width="100%" height="auto" />

Enjoy a balance of beauty and performance designed to keep you focused on what truly matters — your code. If you’re enjoying the Vermilion Theme, support the project by starring it or becoming a sponsor!
...
To get the best experience and full aesthetic consistency, we recommend installing these extensions:

- [Material Icon Theme](https://marketplace.visualstudio.com/items?itemName=PKief.material-icon-theme) – beautiful and colorful file icons
...
- [Auto Close Tag](https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-close-tag) – instantly close HTML/XML tags while typing
- [Auto Complete Tag](https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-complete-tag) – improve tag completion for faster HTML editing
- [Path Autocomplete](https://marketplace.visualstudio.com/items?itemName=ionutvmi.path-autocomplete) – smart path suggestions for imports and files
- [Path Intellisense](https://marketplace.visualstudio.com/items?itemName=christian-kohler.path-intellisense) – autocompletion for file paths and directories
- [Better Comments](https://marketplace.visualstudio.com/items?itemName=aaron-bond.better-comments) – organize and highlight your comments beautifully
  ```
  // @comments(custom)
  ...
  ```
- [Sublime Text Keymap](https://marketplace.visualstudio.com/items?itemName=ms-vscode.sublime-keybindings) and Settings – use familiar Sublime Text shortcuts
- [SVG Preview](https://marketplace.visualstudio.com/items?itemName=SimonSiefke.svg-preview) – instantly preview SVG files inside VS Code
